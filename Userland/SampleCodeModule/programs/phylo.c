...
static char *phylo_names[] = {
    "Messi", "Mirtha", "Colapinto", "Borges",
    "Ricky Fort", "Tinelli", "Coscu", "Del Potro",
    "Dibu Martinez", "Mauro Icardi"
};
...
int8_t phylo_main() {
    printf("Problema de los filosofos... pero con celebridades argentinas comiendo asado.\nCada celebridad necesita dos cubiertos para poder comer.\nPresioná 'a' para sumar una celebridad, 'r' para sacar una o 'q' para terminar.\n");
